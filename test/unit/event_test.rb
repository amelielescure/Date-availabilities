...
class EventTest < ActiveSupport::TestCase
  ...
  test "one simple test example" do
    ...
    Event.create kind: 'opening', starts_at: DateTime.parse("2014-08-14 08:00"), ends_at: DateTime.parse("2014-08-14 10:00"), weekly_recurring: false
    ...
    assert_equal ["8:00", "9:00", "9:30", "12:30", "13:30", "14:00", "15:00", "15:30"], availabilities[4][:slots]
